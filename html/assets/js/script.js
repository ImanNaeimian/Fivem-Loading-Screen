/* Deaveloper_______________________
https://imannaeimian.site/
...
if (showDeveloperTeam){
	$(".panel-2.Developerteam").show()
	Developer_team.forEach(function(user){
		$(".Developer_team").append(`
			<div class="staff">
				<div class="info">
					<img src="${user.image}" class="pfp">
					<p>${user.name}</p>
